...
const CreateToplist = () => {
  ...
  const handleToplistCreate = async () => {
    ...
    try {
        ...
        const resp = await axios.post(`${import.meta.env.VITE_API_URL}/toplists`, newToplist, {
            headers: {
  ...
  return (
    <Container style={{ width: '50%' }}>
          ...
          <li key={item.rank}>
            {item.rank === editItemId ? (
              <div>
                ...
                <Form.Group controlId={`editDescription${item.rank}`}>
                  <Form.Control
                    type="text"
                ...
                <Button variant="success" onClick={saveItem} className="mr-2">
                  Save
                </Button>
              ...
              <div>
                ...
                <Button
                  ...
                  size="sm"
                  className="mr-2"
                  onClick={() => editItem(item.rank, item.title, item.description)}
                >
                  Edit
                </Button>
                <Button
      ...
      <div style={{ position: 'fixed', left: 0, bottom: 20, width: '100%', textAlign: 'center' }}>
